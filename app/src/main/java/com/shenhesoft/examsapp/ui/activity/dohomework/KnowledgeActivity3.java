 ...
 * @desc 做题——》选择知识点3
 */
public class KnowledgeActivity3 extends XTitleActivity<KnowledgePresent> implements KnowledgeView {
        ...
        adapter.setOnItemClickListener(new BaseQuickAdapter.OnItemClickListener() {
            ...
            public void onItemClick(BaseQuickAdapter adapter, View view, int position) {
                Router.newIntent(context).to(AnswerActivity.class)
                        ...
                        .putString("answerPolicyName", AppConstant.AnswerPolicy2)
                        .putString("productId", knowledgeModelList.get(position).getId())
                        .launch();
            }
        });
    ...
    public int getLayoutId() {
        return R.layout.activity_knowledge3;
    }
